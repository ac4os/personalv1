...
$stmt = $pdo->prepare("SELECT nome FROM usuarios WHERE id = :aluno_id AND tipo = 'aluno'");
...
<head>
    <meta charset="UTF-8">
    <title>Evolução de <?= htmlspecialchars($aluno["nome"]) ?></title>
...
<body>
    ...
    <h2>Evolução de <?= htmlspecialchars($aluno["nome"]) ?></h2>
